...
<div id="page" class="site">
   ...
   <header class="header">
         ...
         <div class="social-cont-lowres">
            <a href="tel:+36203942489"><img src="<?php bloginfo('template_url'); ?>/dev/img/icon-phone.svg" alt="facebook icon" /></a>
            <a href="https://www.facebook.com/elmostixvisualpoi/"><img src="<?php bloginfo('template_url'); ?>/dev/img/icon-facebook.svg" alt="facebook icon" /></a>
